 ...
 * 
 */
public class Fx_DisableUser extends AbstractFxImpl implements I_Fx {
	...
	protected FxValidationResponse validate() {
		this.logger.debug("executing Fx_DisableUser.validate()");
	...
	protected void _completeAlert(AlertVo alertVo) {
		...
		alertVo.setDescription(this.getRealMessageSolver().getMessage(
				"fx.disableUser.alert.description",
	...
	protected JsonResponse _execute() {
		this.logger.debug("executing Fx_DisableUser._execute()");
		...
		try {
			...
			this.getVo().disable(this.getVo().getDisabledCause());
			...
			this.logger.error("error executing Fx_DisableUser._execute()", e);
