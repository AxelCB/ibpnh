package org.ibpnh.core.dao.configuration.mail;
...
import org.ibpnh.core.model.configuration.mail.Mail;
import org.ibpnh.core.model.configuration.mail.Mail_;
...
public class MailDaoImpl extends AbstractDao<Mail, MailVo> implements I_MailDao {
	 ...
	 * 
	 * @see
	 * org.ibpnh.core.dao.AbstractDao#addFilters(javax.persistence.criteria
	 * .Root, javax.persistence.criteria.CriteriaBuilder,
	 * javax.persistence.criteria.Predicate, org.ibpnh.core.vo.AbstractVo)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.ibpnh.core.dao.configuration.mail.I_MailDao#checkNameUniqueness
	 ...
	 * 
	 * @see
	 * org.ibpnh.core.dao.configuration.mail.I_MailDao#compileField(javax
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ibpnh.core.dao.configuration.mail.I_MailDao#findByName(javax.
