 ...
 */
public class CustomObjectifyFactory implements FactoryBean<ObjectifyFactory>, InitializingBean {
...
//            classes.addAll(doScan());
            ...
            classes.add(DailyDevotional.class);
//            classes.add(Parameter.class);
        }
