 ...
 */
public class CustomObjectifyFactoryBean{ //implements FactoryBean<ObjectifyFactory> {

    protected final Log logger = LogFactory.getLog(CustomObjectifyFactoryBean.class);
...
//        }
        ...
        classes.add(RoleFunction.class);
        classes.add(RoleType.class);
        classes.add(RoleTypeFunction.class);
        classes.add(MenuOrder.class);
        classes.add(MenuOrderFunction.class);
