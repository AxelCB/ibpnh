...
/**
 *
 * @author AxelCollardBovy ,created on 10/20/2015.
 * 
 */
public class JCacheParameterCacheImpl implements I_CacheProfiler,//extends AbstractCacheProfiler
		I_UserCacheManager,I_ParameterCacheManager {

	/**
	 * Logger.
	 */
	private Logger logger = LoggerFactory.getLogger(JCacheParameterCacheImpl.class);
